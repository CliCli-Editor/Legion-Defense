...
return function(Reactive)
    ...
    local function createRef(value, isReadonly, shallow)
        ...
        value = shallow and value or (isObject(value) and Reactive.reactive(value) or value)
        ...
        if isReadonly then
            ...
            setter = function(self, newValue)
                ...
                value = shallow and newValue or (isObject(value) and Reactive.reactive(newValue) or newValue)
