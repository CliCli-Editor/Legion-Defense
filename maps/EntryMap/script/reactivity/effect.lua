...
local function trigger(target, triggerType, key, newValue, oldValue)
    ...
    --         targetNames = targetNames .. ';' .. key;
    --     end
    --     print("======= trigger effect", key, names, newValue, oldValue, targetNames, target)
    -- else
    --     print("======= trigger effect", key, newValue, oldValue)
    -- end
    -- print("======= run effect count ", #effects)
    for i, effect in ipairs(effects) do
        -- print("======= run effect ", effect.id);
