        ...
        return __TS__New(
            ...
            function(____, resolve, reject)
                ...
                function fulfilled(self, value)
                    ...
                    while resultOrError ~= nil and resultOrError['runInMainThread'] ~= nil do
                        xpcall(resultOrError['runInMainThread'], print);
                        success, resultOrError = coresume(asyncCoroutine, value)
                    end

                    if success then
                        return step(resultOrError)
                    end
                    return reject(nil, tostring(resultOrError) .. "\n" .. debug.traceback(asyncCoroutine))
                end
