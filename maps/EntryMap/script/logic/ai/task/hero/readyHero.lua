...
__TS__SourceMapTraceBack(debug.getinfo(1).short_src, {["5"] = 1,["6"] = 1,["7"] = 4,["8"] = 4,["10"] = 13,["11"] = 15,["12"] = 15,["13"] = 15,["14"] = 16,["15"] = 19,["16"] = 15,["17"] = 15,["18"] = 13});
local ____exports = {}
...
--- 选择英雄
function ____exports.readyHero(self, params)
    return _____6267_884C(
        nil,
        function()
            self:log(function() return "准备" end)
            playerController:ready(self.playerId)
        end
    )
end
return ____exports
