...
____class_0.prototype["施法完成"] = function(self, ability, cast)
    if self["动画参数2"] ~= nil then
        ...
        self:play("attack1", 1.54, 0.75, -1)
    end
    local ____self_1 = _____6570_503C["佣兵技能"]["埃及猫普通攻击"]
    ...
    local p = self:createProjectile(134217909, self.owner, angle, 150)
