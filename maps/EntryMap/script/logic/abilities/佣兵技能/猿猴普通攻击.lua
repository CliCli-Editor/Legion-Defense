...
____class_0.prototype["施法出手"] = function(self, ability, cast)
    local ____self_1 = _____6570_503C["佣兵技能"]["猿猴普通攻击"]
...
____exports.key = ____createAbility_5(
    ...
    134222477,
    ____class_0,
    {["施法开始"] = 0.35, ["施法引导"] = 0, ["施法出手"] = 0.45, ["施法完成"] = 0}
)
return ____exports
