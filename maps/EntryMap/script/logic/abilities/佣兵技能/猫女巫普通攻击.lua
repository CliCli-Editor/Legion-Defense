...
____class_0.prototype["施法完成"] = function(self, ability, cast)
    if self["动画参数2"] ~= nil then
        ...
        self:play("attack1", 1.21, 0.75)
    end
    local ____self_1 = _____6570_503C["佣兵技能"]["猫女巫普通攻击"]
    ...
    local p = self:createProjectile(134230499, self.owner, angle, 150)
