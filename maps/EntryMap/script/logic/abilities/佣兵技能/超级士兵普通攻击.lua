...
____class_0.prototype["施法出手"] = function(self, ability, cast)
    ...
    local ____self_1 = _____6570_503C["佣兵技能"]["超级士兵普通攻击"]
    local v = ____self_1["伤害"](____self_1, self.owner)
    local ____self_2 = _____6570_503C["佣兵技能"]["超级士兵普通攻击"]
    local c = ____self_2["治疗"](____self_2)
