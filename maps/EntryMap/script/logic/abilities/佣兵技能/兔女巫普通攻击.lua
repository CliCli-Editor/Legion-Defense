...
____class_0.prototype["施法完成"] = function(self, ability, cast)
    if self["动画参数2"] ~= nil then
        ...
        self:play("attack1", 2, 0.6)
    end
    local ____self_1 = _____6570_503C["佣兵技能"]["兔女巫普通攻击"]
    ...
    local p = self:createProjectile(134268325, self.owner, angle, 150)
...
____exports.key = ____createAbility_3(
    ...
    134271938,
    ____class_0,
    {["施法开始"] = 0, ["施法引导"] = 0, ["施法出手"] = 0.1, ["施法完成"] = 0.7}
)
return ____exports
