...
____class_0.prototype["施法出手"] = function(self, ability, cast)
    ...
    local p = self:createProjectile(134239314, self.owner, angle, 150)
    p:listener({onFinish = function()
        local ____self_1 = _____6570_503C["石巨人"]["普通攻击"]
...
____exports.key = ____createAbility_3(nil, ____fight_2, 134278091, ____class_0)
return ____exports
