                ...
                return __TS__AsyncAwaiter(function(____awaiter_resolve)
                    ...
                    do
                        ...
                        while i < 20 do
                            ...
                            local p = self:createProjectile(134233600, startPos, angle, 150)
                            p:prepare({hit_type = 0, hit_radius = 50, hit_same = true})
                            p:listener({
                                onFinish = function()
                                    p:remove()
                                end,
